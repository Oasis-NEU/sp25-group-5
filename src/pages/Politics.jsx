          ...
          <div className="articles-container">
            ...
            <article className="news-article">
              ...
              <div className="article-content">
                <h2>
                  <a
                    href="https://www.cnn.com/politics/live-news/trump-news-03-20-25/index.html?utm_source=chatgpt.com"
                    target="_blank"
            ...
            <article className="news-article">
              ...
              <div className="article-content">
                <h2>
                  <a
                    href="https://www.businessinsider.com/judge-blocked-doge-social-security-records-scathing-ruling-2025-3"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
